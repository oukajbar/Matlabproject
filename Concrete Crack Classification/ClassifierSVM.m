function [trainedClassifier, validationAccuracy] = ClassifierSVM(trainingData)
...
% Auto-generated by MATLAB on 09-Feb-2024 13:00:57
...
predictorNames = "f" + string(1:500);
predictors = inputTable(:, predictorNames);
response = inputTable.labels;
isCategoricalPredictor = false(1, 500);
classNames = categorical({'No Crack'; 'Crack'}, {'No Crack' 'Crack'});
...
trainedClassifier.RequiredVariables = "f" + string(1:500);
